...
@Component({
  selector: 'app-add-other-items',
  templateUrl: './add-other-items.component.html',
  styleUrls: ['./add-other-items.component.css']
})
export class AddOtherItemsComponent implements OnInit {
  ...
  openDialog(){
    this.dialog.open(OtherItemsComponent,{
      width: '55%',
